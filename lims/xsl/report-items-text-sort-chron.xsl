...
<xsl:stylesheet version="1.0"
   ...
   <xsl:template name = "header">
     ...
     <xsl:text>&#10;&#10;&#10;&#10;</xsl:text>
     <xsl:text>                                                    item                                                 &#10;</xsl:text>
     <xsl:text>title                                               coll   chronology       barcode         call number  &#10;</xsl:text>
     <xsl:text>--------------------------------------------------  -----  ---------------  --------------  -----------  &#10;</xsl:text>
   </xsl:template>
   ...
   <xsl:template match = "item">
     ...
     <xsl:value-of select = "java:pad( $x, concat( z30-chronological-i, ' ', z30-enumeration-j, ' ', z30-chronological-k, ' ', z30-chronological-l ), 15 )"/>
     <xsl:text>  </xsl:text>
