<xsl:stylesheet version="1.0"
   ...
   <!-- Differences from report-items-text.xsl:
      ...
      2005/03/28: Yalan
        - modified for ML - added z30-order-number and z30-price
   ...
   <xsl:template name = "header">
     ...
     <!-- Header -->
     <xsl:text>title                                    author          imprint         year isbn                 sublib coll  order num  price       call number &#10;</xsl:text>
     <xsl:text>---------------------------------------- --------------- --------------- ---- -------------------- ------ ----- ---------- ----------  ----------- &#10;</xsl:text>
   </xsl:template>
   ...
   <xsl:template match="item">
     ...
     <xsl:value-of select = "java:pad( $x, z30-order-number, 11 )"/>
     <xsl:value-of select = "java:pad( $x, z30-price, 11 )"/>
