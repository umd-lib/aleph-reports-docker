...
<font size=-1>The timestamp is the time the stats were generated</font><br>

<select name="report" size="15">

  <c:set var="xml">
    <jsp:getProperty name="crep" property="reportList"/>
  </c:set>
...
<%--
  <tr>
    <td colspan="2">
      ...
      <x:transform xml="${xml}" xslt="${xsl}">
      	<x:param name="selected" value="<%= crep.getCampus() %>"/>
      </x:transform>
    </td>
  </tr>
--%>
